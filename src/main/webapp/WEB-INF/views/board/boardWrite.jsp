...
<body>
	...
	<form action="/bod/writeProc" method="post"
		...
		<table border="1" align="center">
			...
			<tr>
				<td><input type="text" size="50" placeholder="제목을 입력하세요."
					name="title">
			</tr>
			<tr>
				<td><input type=file name="file" multiple>
				<!-- multiple 있으면 여러파일 가능  -->
			</tr>
			<tr>
				<td><textarea cols="80" rows="15" placeholder="내용을 입력하세요."
						name="contents"></textarea>
			</tr>
			<tr>
				<td align="right"><input type="submit" value="작성" id="write">
